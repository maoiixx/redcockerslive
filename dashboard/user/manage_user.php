		...
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group">
					...
					<input type="number" name="rate" id="rate" min="0" max="11" inputmode="numeric" pattern="[0-9]*" step = "0.0001" class="form-control" value="<?php echo isset($meta['rate']) ? $meta['rate']: '' ?>" required>
				</div>
