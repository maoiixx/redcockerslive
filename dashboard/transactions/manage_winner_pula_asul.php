...
<div class="container-fluid">
	<form action="" id="transaction-form">      
		...
		<div class="row">
		<div class="col p-1 text-center pt-0 dark-bg"><button class="btn btn-success btn-grad-red" onclick="toggleMeron()">PULA</button></div>
		<div class="col p-1 text-center pt-0 dark-bg"><button class="btn btn-success btn-grad-blue" onclick="toggleWala()">ASUL</button></div>
		</div>
		<div class="row">
