...
<script>
	$(document).ready(function(){
		...
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Edit Template Details",'maintenance/manage_template.php?id='+$(this).attr('data-id'))
		})
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Create New Template",'maintenance/manage_template.php')
		})
		$('#example').DataTable( {
                stateSave: true
                } );
