...
<div class="container-fluid">
	<form action="" id="transaction-form">
        ...
        <?php if($_GET['betid'] == 1): ?>
		    ...
		    <input name="red_amount" id="red_amount" type="number" inputmode="numeric" pattern="[0-9]*" min="10" max="2000"step="1" class="form-control form  rounded-0" value=<?php echo $_GET['bet']?> readonly >
        ...
        <?php elseif($_GET['betid'] == 2): ?>
		    ...
		    <input name="blue_amount" id="blue_amount" type="number" inputmode="numeric" pattern="[0-9]*" min="10" max="2000"step="1" class="form-control form  rounded-0" value=<?php echo $_GET['bet']?> readonly >
        ...
        <?php else: ?>
		    ...
		    <input name="yellow_amount" id="yellow_amount" type="number" inputmode="numeric" pattern="[0-9]*" min="10" max="2000"step="1" class="form-control form  rounded-0" value=<?php echo $_GET['bet']?> readonly >
            <input type="hidden" name ="red_amount" id="red_amount"value="0">
            <input type="hidden" name ="blue_amount" id="blue_amount" value="0">
