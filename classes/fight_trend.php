...
<table class="table-responsive" style="width: 100%; height:260px;background-color:#c7c3b9">
				<tbody>
                    <?php echo $row1 ?>
                    <?php echo $row2 ?>
                    <?php echo $row3 ?>
...
<div class="row">
    <div class="col p-0 text-center pt-0" style="color:black">
    MERON
    </div>
    <div class="col p-0 text-center pt-0" style="color:black">
    WALA
...
<table class="table-responsive" style="width: 100%; height:240px;background-color:#c7c3b9">
				<tbody>
                    <?php echo $row1 ?>
                    <?php echo $row2 ?>
                    <?php echo $row3 ?>
